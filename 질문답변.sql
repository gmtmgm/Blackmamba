...
INSERT INTO 답변(intent_id, answer_id, answer) VALUES (3, 3, ' 입니다.\n\n%s에 포함된 알레르기 성분:');
INSERT INTO 답변(intent_id, answer_id, answer) VALUES (4, 4, '(이)가 포함된 메뉴를 필터링해서 보여드릴까요?');
INSERT INTO 답변(intent_id, answer_id, answer) VALUES (5, 5, '%s 성분이 포함된 메뉴를 필터링하였습니다. 이제부터 메뉴 검색시, %s(이)가 포함된 메뉴가 제외됩니다.');
INSERT INTO 답변(intent_id, answer_id, answer) VALUES (6, 6, '%s 메뉴에는');
